      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6">
          ...
          <div class="d-flex gap-3 my-4">
            <a href="#" class="btn btn-green px-4">Get Started</a>
            <a href="#" class="btn btn-outline-green px-4">Get free trial</a>
          </div>
        ...
        <div class="col-lg-6 text-center position-relative">
          <div class="position-relative">
            ...
            <!-- Stats -->
            <div class="stats-box position-absolute translate-middle-y" style="left: 0; top:10%">
              <div class="d-flex align-items-center p-2">
                <i class="bi bi-play-circle me-2 fs-4 text-warning"></i>
                <div class="text-dark">
                  <div class="fw-bold">2K+</div>
                  <small class="text-description">Video Courses</small>
                </div>
              </div>
            </div>

            <div class="stats-box position-absolute top-0 end-0 translate-middle-y" style="right: 0;">
              <div class="d-flex align-items-center p-2">
                <i class="bi bi-journal-code me-2 fs-4 text-warning"></i>
                <div class="text-dark">
                  <div class="fw-bold">5K+</div>
                  <small class="text-description">Online Courses</small>
                </div>
              </div>
            </div>

            <div class="stats-box position-absolute bottom-0 end-0 translate-middle-y" style="right: 0;">
              <div class="d-flex align-items-center p-2">
                <i class="bi bi-person-video3 me-2 fs-4 text-warning"></i>
                <div class="text-dark">
                  <div class="fw-bold">250+</div>
                  <small class="text-description">Tutors</small>
                </div>
              </div>
            </div>
          </div>
